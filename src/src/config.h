...
#include <build_config.h>
    ...
    extern "C" DTALIBRARY_API double network_assignment(int assignment_mode, int VDF_type, int iteration_number, int column_updating_iterations, int ODME_iterations, int number_of_memory_blocks);
#endif
