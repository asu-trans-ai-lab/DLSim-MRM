...
int main()
{
    ...
    network_assignment(assignment_mode, iteration_number, column_updating_iterations, ODME_iterations, sensitivity_analysis_iterations, simulation_iterations, number_of_memory_blocks);
